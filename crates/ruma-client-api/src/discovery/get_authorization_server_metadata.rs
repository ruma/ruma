...
pub mod v1 {
    ...
    impl AuthorizationServerMetadata {
        ...
        ///
        /// This function tries to be backwards compatible with unstable implementation by selecting
        /// the proper action value to add to the URL (stable or unstable) given the supported
        /// actions advertised in this metadata.
        ///
