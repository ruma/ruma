...
pub struct Request {
    ...
    pub one_time_keys: BTreeMap<UserId, BTreeMap<DeviceId, OneTimeKeyAlgorithm>>,
}
...
impl Request {
    ...
    pub fn new(one_time_keys: BTreeMap<UserId, BTreeMap<DeviceId, OneTimeKeyAlgorithm>>) -> Self {
