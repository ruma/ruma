//! [POST /_matrix/client/r0/account/3pid/bind](https://matrix.org/docs/spec/client_server/r0.6.1#post-matrix-client-r0-account-3pid-bind)
...
ruma_api! {
    metadata: {
        ...
        method: POST,
        name: "bind_3pid",
        r0: "/_matrix/client/r0/account/3pid/bind",
        stable: "/_matrix/client/v3/account/3pid/bind",
        rate_limited: true,
