//! [GET /_matrix/client/r0/register/available](https://matrix.org/docs/spec/client_server/r0.6.1#get-matrix-client-r0-register-available)
...
ruma_api! {
    metadata: {
        ...
        r0: "/_matrix/client/r0/register/available",
        stable: "/_matrix/client/v3/register/available",
        rate_limited: true,
        authentication: None,
        added: 1.0,
    }
