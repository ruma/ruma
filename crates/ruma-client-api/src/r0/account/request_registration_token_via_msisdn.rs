//! [POST /_matrix/client/r0/register/msisdn/requestToken](https://matrix.org/docs/spec/client_server/r0.6.1#post-matrix-client-r0-register-msisdn-requesttoken)
...
ruma_api! {
    metadata: {
        ...
        r0: "/_matrix/client/r0/register/msisdn/requestToken",
        stable: "/_matrix/client/v3/register/msisdn/requestToken",
        rate_limited: false,
        authentication: None,
        added: 1.0,
    }
