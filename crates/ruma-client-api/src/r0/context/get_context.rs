//! [GET /_matrix/client/r0/rooms/{roomId}/context/{eventId}](https://matrix.org/docs/spec/client_server/r0.6.1#get-matrix-client-r0-rooms-roomid-context-eventid)
...
ruma_api! {
    metadata: {
        ...
        method: GET,
        r0: "/_matrix/client/r0/rooms/:room_id/context/:event_id",
        stable: "/_matrix/client/v3/rooms/:room_id/context/:event_id",
        name: "get_context",
        rate_limited: false,
