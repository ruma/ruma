//! [GET /_matrix/media/r0/config](https://matrix.org/docs/spec/client_server/r0.6.1#get-matrix-media-r0-config)
...
ruma_api! {
    metadata: {
        ...
        method: GET,
        r0: "/_matrix/media/r0/config",
        stable: "/_matrix/media/v3/config",
