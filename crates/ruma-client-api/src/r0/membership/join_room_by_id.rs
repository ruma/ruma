//! [POST /_matrix/client/r0/rooms/{roomId}/join](https://matrix.org/docs/spec/client_server/r0.6.1#post-matrix-client-r0-rooms-roomid-join)
...
ruma_api! {
    metadata: {
        ...
        r0: "/_matrix/client/r0/rooms/:room_id/join",
        stable: "/_matrix/client/v3/rooms/:room_id/join",
        rate_limited: true,
