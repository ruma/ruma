//! [POST /_matrix/client/r0/rooms/{roomId}/unban](https://matrix.org/docs/spec/client_server/r0.6.1#post-matrix-client-r0-rooms-roomid-unban)
...
ruma_api! {
    metadata: {
        ...
        method: POST,
        name: "unban_user",
        r0: "/_matrix/client/r0/rooms/:room_id/unban",
        stable: "/_matrix/client/v3/rooms/:room_id/unban",
        rate_limited: false,
