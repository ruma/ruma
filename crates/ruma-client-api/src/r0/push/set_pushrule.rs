//! [PUT /_matrix/client/r0/pushrules/{scope}/{kind}/{ruleId}](https://matrix.org/docs/spec/client_server/r0.6.1#put-matrix-client-r0-pushrules-scope-kind-ruleid)
...
ruma_api! {
    metadata: {
        ...
        method: PUT,
        name: "set_pushrule",
        r0: "/_matrix/client/r0/pushrules/:scope/:kind/:rule_id",
        stable: "/_matrix/client/v3/pushrules/:scope/:kind/:rule_id",
        rate_limited: true,
