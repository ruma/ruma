//! [PUT /_matrix/client/r0/pushrules/{scope}/{kind}/{ruleId}/enabled](https://matrix.org/docs/spec/client_server/r0.6.1#put-matrix-client-r0-pushrules-scope-kind-ruleid-enabled)
...
ruma_api! {
    metadata: {
        ...
        r0: "/_matrix/client/r0/pushrules/:scope/:kind/:rule_id/enabled",
        stable: "/_matrix/client/v3/pushrules/:scope/:kind/:rule_id/enabled",
        rate_limited: false,
