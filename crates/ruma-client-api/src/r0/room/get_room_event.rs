//! [GET /_matrix/client/r0/rooms/{roomId}/event/{eventId}](https://matrix.org/docs/spec/client_server/r0.6.1#get-matrix-client-r0-rooms-roomid-event-eventid)
...
ruma_api! {
    metadata: {
        ...
        method: GET,
        name: "get_room_event",
        r0: "/_matrix/client/r0/rooms/:room_id/event/:event_id",
        stable: "/_matrix/client/v3/rooms/:room_id/event/:event_id",
        rate_limited: false,
