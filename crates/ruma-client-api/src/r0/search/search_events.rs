//! [POST /_matrix/client/r0/search](https://matrix.org/docs/spec/client_server/r0.6.1#post-matrix-client-r0-search)
...
ruma_api! {
    metadata: {
        ...
        method: POST,
        name: "search",
        r0: "/_matrix/client/r0/search",
        stable: "/_matrix/client/v3/search",
        rate_limited: true,
