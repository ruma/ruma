//! [GET /_matrix/client/r0/admin/whois/{userId}](https://matrix.org/docs/spec/client_server/r0.6.1#get-matrix-client-r0-admin-whois-userid)
...
ruma_api! {
    metadata: {
        ...
        method: GET,
        name: "get_user_info",
        r0: "/_matrix/client/r0/admin/whois/:user_id",
        stable: "/_matrix/client/v3/admin/whois/:user_id",
        rate_limited: false,
