//! [GET /_matrix/client/r0/rooms/{roomId}/state](https://matrix.org/docs/spec/client_server/r0.6.1#get-matrix-client-r0-rooms-roomid-state)
...
ruma_api! {
    metadata: {
        ...
        r0: "/_matrix/client/r0/rooms/:room_id/state",
        stable: "/_matrix/client/v3/rooms/:room_id/state",
        rate_limited: false,
