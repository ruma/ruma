//! [GET /_matrix/client/r0/user/{userId}/rooms/{roomId}/tags](https://matrix.org/docs/spec/client_server/r0.6.1#get-matrix-client-r0-user-userid-rooms-roomid-tags)
...
ruma_api! {
    metadata: {
        ...
        method: GET,
        name: "get_tags",
        r0: "/_matrix/client/r0/user/:user_id/rooms/:room_id/tags",
        stable: "/_matrix/client/v3/user/:user_id/rooms/:room_id/tags",
        rate_limited: false,
