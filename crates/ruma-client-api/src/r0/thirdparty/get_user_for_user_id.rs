//! [GET /_matrix/client/r0/thirdparty/user](https://matrix.org/docs/spec/client_server/r0.6.1#get-matrix-client-r0-thirdparty-user)
...
ruma_api! {
    metadata: {
        ...
        r0: "/_matrix/client/r0/thirdparty/user",
        stable: "/_matrix/client/v3/thirdparty/user",
        rate_limited: false,
