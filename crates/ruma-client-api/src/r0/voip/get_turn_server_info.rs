//! [GET /_matrix/client/r0/voip/turnServer](https://matrix.org/docs/spec/client_server/r0.6.1#get-matrix-client-r0-voip-turnserver)
...
ruma_api! {
    metadata: {
        ...
        r0: "/_matrix/client/r0/voip/turnServer",
        stable: "/_matrix/client/v3/voip/turnServer",
        rate_limited: true,
