...
- Add `REQUIRED_SCOPES` associated constant to `Metadata` and accompanying `required_scopes` syntax to
  `metadata!` macro, to allow request structs to define what OAuth 2.0 scopes they require.
