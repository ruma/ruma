...
use crate::{
    events::{
        AnyStrippedStateEvent, EventContent, HasDeserializeFields, MessageLikeUnsigned,
        RedactContent, RedactedEventContent, Relations, StateEventContent, StateEventType,
    },
...
impl From<RoomMemberUnsigned> for MessageLikeUnsigned {
    fn from(unsigned: RoomMemberUnsigned) -> Self {
        let RoomMemberUnsigned { age, transaction_id, relations, .. } = unsigned;
        Self { age, transaction_id, relations }
    }
}
