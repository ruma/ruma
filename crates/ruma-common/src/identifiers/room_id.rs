...
mod tests {
    use super::RoomId;
    use crate::{IdParseError, owned_server_name};
    ...
    fn empty_localpart() {
        ...
        assert_eq!(room_id.server_name(), Some(owned_server_name!("example.com")));
    }

    #[cfg(feature = "rand")]
    #[test]
    fn generate_random_valid_room_id() {
        let room_id = RoomId::new_v1(&owned_server_name!("example.com"));
    ...
    fn valid_room_id_with_explicit_standard_port() {
        ...
        assert_eq!(room_id.server_name(), Some(owned_server_name!("example.com:443")));
    }
