...
impl UserId {
    ...
    #[cfg(feature = "rand")]
    pub fn new(server_name: &ServerName) -> UserId {
        UserId::from_string_unchecked(format!(
            "@{}:{}",
    ...
    pub fn parse_with_server_name(
        ...
        if id_str.starts_with('@') {
            ...
            Ok(UserId::from_string_unchecked(format!("@{id_str}:{server_name}")))
        }
    }
