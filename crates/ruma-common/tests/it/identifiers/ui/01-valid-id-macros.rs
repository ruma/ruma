fn main() {
    _ = ruma_common::base64_public_key!("acR1l0raoZnm60CBwAVgqbZqoO/mYU81xysh1u7XcJk");
    _ = ruma_common::device_id!("DEVICE");
    ...
    #[cfg(feature = "unstable-identifier-owned-macros")]
    {
        ...
        _ = ruma_common::owned_room_id!("!1234567890:matrix.org");
    ...
    {
        _ = ruma_common::base64_public_key_ref!("acR1l0raoZnm60CBwAVgqbZqoO/mYU81xysh1u7XcJk");
        _ = ruma_common::device_id_ref!("DEVICE");
        ...
        _ = ruma_common::session_id_ref!("Sessi0n");
