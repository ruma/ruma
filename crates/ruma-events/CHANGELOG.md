...
- The `EventContent` macro never generates a `PossiblyRedacted*EventContent` type for state events
  anymore. The `AnyPossiblyRedactedStateEventContent` enum was removed.
