...
#[cfg(test)]
mod tests {
    use ruma_common::owned_server_name;
    ...
    fn acl_ignores_port() {
        ...
        assert!(!acl_event.is_allowed(&owned_server_name!("1.1.1.1:8000")));
    }
    ...
    fn acl_allow_ip_literal() {
        ...
        assert!(acl_event.is_allowed(&owned_server_name!("1.1.1.1")));
    }
    ...
    fn acl_deny() {
        ...
        assert!(!acl_event.is_allowed(&owned_server_name!("matrix.org")));
        assert!(acl_event.is_allowed(&owned_server_name!("conduit.rs")));
    }
    ...
    fn acl_explicit_glob_1() {
        ...
        assert!(!acl_event.is_allowed(&owned_server_name!("matrix.org")));
        assert!(acl_event.is_allowed(&owned_server_name!("server.matrix.org")));
    }
    ...
    fn acl_explicit_glob_2() {
        ...
        assert!(!acl_event.is_allowed(&owned_server_name!("matrix1.org")));
        assert!(acl_event.is_allowed(&owned_server_name!("matrix02.org")));
    }
    ...
    fn acl_ipv6_glob() {
        ...
        assert!(!acl_event.is_allowed(&owned_server_name!("[2001:db8:1234::2]")));
        assert!(acl_event.is_allowed(&owned_server_name!("[2001:db8:1234::1]")));
    }
    ...
    fn acl_case_insensitive() {
        ...
        assert!(!acl_event.is_allowed(&owned_server_name!("Bad.ServeR")));
        assert!(!acl_event.is_allowed(&owned_server_name!("bAD.sERvER")));
        assert!(!acl_event.is_allowed(&owned_server_name!("bAd.server")));
        assert!(acl_event.is_allowed(&owned_server_name!("good.ServEr")));
        assert!(acl_event.is_allowed(&owned_server_name!("good.server")));
        assert!(acl_event.is_allowed(&owned_server_name!("GOOD.SERVER")));
    }
}
