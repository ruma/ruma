...
use super::{
    MessageLikeEventContent, OriginalSyncMessageLikeEvent, StaticStateEventContent,
...
pub trait EventUnsignedData {
    ...
    ///
    /// This shold return `true` when the unsigned data has a `redacted_because` field that is set.
