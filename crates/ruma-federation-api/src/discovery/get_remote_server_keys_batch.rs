...
pub mod v2 {
    ...
    use ruma_common::{
        MilliSecondsSinceUnixEpoch, OwnedServerName, ServerSigningKeyId,
    ...
    pub struct Request {
        ...
        pub server_keys: BTreeMap<OwnedServerName, BTreeMap<ServerSigningKeyId, QueryCriteria>>,
    }
    ...
    impl Request {
        ...
        pub fn new(
            server_keys: BTreeMap<OwnedServerName, BTreeMap<ServerSigningKeyId, QueryCriteria>>,
        ) -> Self {
            Self { server_keys }
        }
    }
