...
/// itself.
///
/// By default, the types generated by this macro get a `#[non_exhaustive]` attribute. This
...
/// attribute. This behavior can be controlled by defining an `unstable-exhaustive-types` cargo
