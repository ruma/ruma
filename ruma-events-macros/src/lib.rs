...
pub fn derive_basic_event_content(input: TokenStream) -> TokenStream {
    let input = parse_macro_input!(input as DeriveInput);
    expand_basic_event_content(&input, false).unwrap_or_else(|err| err.to_compile_error()).into()
}
...
pub fn derive_room_event_content(input: TokenStream) -> TokenStream {
    let input = parse_macro_input!(input as DeriveInput);
    expand_room_event_content(&input, false).unwrap_or_else(|err| err.to_compile_error()).into()
}
...
pub fn derive_message_event_content(input: TokenStream) -> TokenStream {
    let input = parse_macro_input!(input as DeriveInput);
    expand_message_event_content(&input, true).unwrap_or_else(|err| err.to_compile_error()).into()
}
...
pub fn derive_state_event_content(input: TokenStream) -> TokenStream {
    let input = parse_macro_input!(input as DeriveInput);
    expand_state_event_content(&input, true).unwrap_or_else(|err| err.to_compile_error()).into()
}
...
pub fn derive_ephemeral_room_event_content(input: TokenStream) -> TokenStream {
    let input = parse_macro_input!(input as DeriveInput);
    expand_ephemeral_room_event_content(&input, false)
