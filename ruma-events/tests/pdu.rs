...
fn serialize_stub_as_v1() {
    ...
    signatures.insert(Box::<ServerName>::try_from("example.com").unwrap(), inner_signature);
...
fn convert_v3_stub_to_pdu() {
    ...
    signatures
        .insert(Box::<ServerName>::try_from("example.com".to_string()).unwrap(), inner_signature);
